...
<style>
	...
	.kysymys {
		border-radius: 5px 10% / 50%;
		border: 2px solid rgb(220, 255, 208);
		background-color: rgba(18, 17, 17, 0.801);
	}
	.keskellä {
		margin: auto;
		width: 80%;
	...
	button {
		...
		border-color: rgb(220, 255, 208);
		background-color: rgb(18, 17, 17);
		color: rgb(220, 255, 208);
		padding: 0.5rem;
	}
</style>
